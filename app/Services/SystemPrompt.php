...
class SystemPrompt
{
    ...
    {
        return "# Prompt Instruksi untuk AI Landing Page Builder
...
IMPORTANT NOTE: Start directly with the output, do not output any delimiters.";
    ...
    {
        return "# Prompt Instruksi untuk AI Generator Deskripsi Tampilan
...
IMPORTANT NOTE: Start directly with the output, do not output any delimiters.";
    ...
    public static function generateStyleFromDesc()
    {
        return "# Prompt Instruksi untuk AI Pengembang Deskripsi Tampilan
...
```";
    ...
    public static function generateMiniApp()
    {
        return "# Prompt Instruksi untuk AI Mini App Builder
...
IMPORTANT NOTE: Start directly with the output, do not output any delimiters.";
    ...
    public static function editMiniApp()
    {
        return "## 1. Peran & Tujuan Utama
...
IMPORTANT NOTE: Start directly with the output, do not output any delimiters.";
    ...
    public static function generateFunctionality()
    {
        return "# Prompt Instruksi untuk AI Generator Fungsionalitas Mini App
...
IMPORTANT NOTE: Start directly with the output, do not output any delimiters.";
    ...
    public static function generateMiniAppStyleNoStyle()
    {
        return "# Prompt Instruksi untuk AI Generator Style Mini App dari Fungsionalitas
...
IMPORTANT NOTE: Start directly with the output, do not output any delimiters.";
    ...
    public static function generateMiniAppStyleWithStyle()
    {
        return "# Prompt Instruksi untuk AI Pengembang Style Mini App
